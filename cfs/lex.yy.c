...
char *yytext;
#line 1 "parsers/phpini/phpini.l"
#line 2 "parsers/phpini/phpini.l"
#include <stdio.h>
#include <stdlib.h>
#include "cfs.h"
...
static inline char * path(char *);

static char * curvar = NULL;
static char * out = NULL;
static char * curcomment = NULL;
ccontext currun;
...
static inline void ADDCOMMENT(char * s) {
    if(curcomment){
        curcomment = (char *) realloc(curcomment, (strlen(curcomment)+strlen(s)+2)*sizeof(char));
        strcat(curcomment, "\n");
        strcat(curcomment, s);    
    } else {
	curcomment = (char *) malloc((strlen(s)+1)*sizeof(char));
	strcpy(curcomment,s);
    }
}

static void FLUSHC(void) { 
    cfile fd;
    fd = cc_create_comment("./");
    cc_write(fd,curcomment);    
    free(curcomment); 
    curcomment = NULL;
}
/*    
static inline char * path(char * str){
    if(curvar){
	char * out;
	out = (char *) malloc((strlen(str) + strlen(curvar) + 3) * sizeof(char));
	strcpy(out, "/");
	strcpy(out+1, curvar);
	strcpy(out+strlen(curvar)+1, "/");
	strcpy(out+strlen(curvar)+2, str);
	return out;
    } else 
	return strdup(str);
}

#define path_destroy() if(out) free(out)
*/
...
#line 72 "parsers/phpini/phpini.l"
...
case 1:
YY_RULE_SETUP
#line 74 "parsers/phpini/phpini.l"
BEGIN(COMMENT);
	YY_BREAK

case 2:
YY_RULE_SETUP
#line 77 "parsers/phpini/phpini.l"
{
	ADDCOMMENT(yytext);
    } 
	YY_BREAK
...
YY_RULE_SETUP
#line 80 "parsers/phpini/phpini.l"
BEGIN(INITIAL);
	YY_BREAK
case YY_STATE_EOF(COMMENT):
#line 81 "parsers/phpini/phpini.l"
yyterminate();
	YY_BREAK

case 4:
YY_RULE_SETUP
#line 84 "parsers/phpini/phpini.l"
FLUSHC(); SETVAR(yytext); BEGIN(VARIABLE);
	YY_BREAK

case 5:
YY_RULE_SETUP
#line 87 "parsers/phpini/phpini.l"
BEGIN(VARIABLE_IS);
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 88 "parsers/phpini/phpini.l"
/*ignore*/
	YY_BREAK
case 7:
/* rule 7 can match eol */
YY_RULE_SETUP
#line 89 "parsers/phpini/phpini.l"
BEGIN(INITIAL);
	YY_BREAK
case 8:
YY_RULE_SETUP
#line 90 "parsers/phpini/phpini.l"
/* throw a dirty error */
	YY_BREAK
...
YY_RULE_SETUP
#line 93 "parsers/phpini/phpini.l"
{
    char * tmp;
    FLUSHC();
    TRIM_WHITESPACE
...
case 10:
YY_RULE_SETUP
#line 106 "parsers/phpini/phpini.l"
/*ignore*/
	YY_BREAK
case 11:
/* rule 11 can match eol */
YY_RULE_SETUP
#line 108 "parsers/phpini/phpini.l"
{ 
	cfile fd;
	TRIM_WHITESPACE 
	TRIM_NEWLINE
...
case 12:
YY_RULE_SETUP
#line 119 "parsers/phpini/phpini.l"
{
	cfile fd;
	TRIM_WHITESPACE 
	TRIM_NEWLINE
...
YY_RULE_SETUP
#line 126 "parsers/phpini/phpini.l"
BEGIN(INITIAL);
	YY_BREAK

case 14:
YY_RULE_SETUP
#line 129 "parsers/phpini/phpini.l"
/* ignore happily */
	YY_BREAK
case 15:
YY_RULE_SETUP
#line 130 "parsers/phpini/phpini.l"
/* throw a dirty error */
	YY_BREAK
case 16:
YY_RULE_SETUP
#line 132 "parsers/phpini/phpini.l"
ECHO;
	YY_BREAK
#line 890 "lex.yy.c"
...
ccontext parser_phpini_read(char * file, char * param){
    yyin = fopen(file,"r");
    if(!yyin)
	return NULL;
    currun = c_init();
